...
Developed by the Center for Creative Leadership, the SBI (Situation-Behavior-Impact) model structures feedback: describe the context, the specific behavior, and its impact. "In last week's retro, when you interrupted Sarah, it shut down the discussion." Concrete feedback is actionable; vague feedback ("you could communicate better") isn't.
